...
export default function NewSubmissionPage(){
 ...
 return <div className={styles.page}><main className={styles.main}><div className={styles.container}>
  ...
  {step===1&&<form onSubmit={(event)=>{event.preventDefault();setStep(2);}} className={`${styles.card} ${styles.assessmentForm}`}><div className={styles.fieldGrid}>
  ...
  </div><div className={styles.formActions}><button className={styles.primaryButton}>Continue to Fire Plan</button></div></form>}
