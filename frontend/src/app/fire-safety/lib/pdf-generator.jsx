...
const styles = StyleSheet.create({
  ...
  rulePassed: {
    borderLeftColor: '#1E5438',
  },
  ruleFailed: {
    borderLeftColor: '#B02016',
  },
  ruleWarning: {
    borderLeftColor: '#9A6608',
  },
  ruleName: {
    fontSize: 11,
    fontWeight: 'bold',
  ...
  statusFail: {
    backgroundColor: '#B02016',
    color: '#ffffff',
  },
  statusWarning: {
    backgroundColor: '#9A6608',
    color: '#ffffff',
  },
  summary: {
    fontSize: 12,
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.section}>
          ...
          <View style={{ flexDirection: 'row', marginBottom: 10 }}>
            ...
            <Text style={{ fontSize: 12, color: '#14221B', marginTop: 5 }}>
