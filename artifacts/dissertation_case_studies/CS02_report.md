# Dissertation Validation Evidence: Case Study CS02
**Case Title**: Tropical Coastal Bungalow (Galle Wet Coastal)  
**Execution Timestamp**: 2026-07-23 12:02:53  
**Backend Pipeline Latency**: 4974.8 ms  

## 1. Executive Summary & Scoring Overview
| Metric | Value | Reference Standard / Notes |
|---|---|---|
| **Overall Hybrid Score** | `84.87` / 100 | Formula: (0.75 × Engineering Score) + (0.25 × ML Score) |
| **Engineering Score (MCDM)** | `92.90` / 100 | SLS Compliance, Structural Load & Microclimate Heuristics |
| **ML Score (Predictive)** | `60.76` / 100 | Random Forest Model Trained on Historical Project Data |
| **ML Alignment Confidence** | `60.8% Confidence` | Feature Alignment with Dataset Specifications |
...
- **Floor Count**: 1 Floors | **Total Gross Area**: 120.0 m²
- **Structural System**: Concrete Frame
- **Budget Tier**: Budget | **Sustainability Priority**: Low

### Microclimate Environmental Snapshot
- **Climate Zone**: Moderate Coastal Humid
- **Temperature Range**: 30.6°C
- **Humidity**: 66%
- **Annual Rainfall**: 2400mm
- **Salinity Level**: Extreme
- **Exposure Score**: 87.80000000000001 (Very High)
...
|---|---|---|---|---|---|---|---|
| **Walls** | Wire-Cut Clay Brick (Premium Grade) | `74.41` | `78.92` | `60.90` | 0.22 | 80 yrs | 85 |
| **Roofing** | Zinc-Aluminium Corrugated Sheet (55% Al-Zn) | `87.92` | `96.78` | `61.34` | 0.42 | 50 yrs | 60 |
| **Windows** | uPVC Multi-Chamber Window System | `86.94` | `96.09` | `59.49` | 0.28 | 45 yrs | 82 |
| **Doors** | FRP Fiberglass Reinforced Door | `87.79` | `96.78` | `60.83` | 0.48 | 60 yrs | 65 |
| **Flooring** | Recycled Composite Decking (WPC) | `88.26` | `97.38` | `60.90` | 0.22 | 30 yrs | 90 |
| **Ceiling** | Calcium Silicate Board Ceiling | `80.20` | `86.93` | `60.00` | 0.28 | 30 yrs | 62 |
| **Finishes** | Advanced Nano-Exterior Paint | `85.45` | `93.44` | `61.49` | 0.25 | 12 yrs | 65 |
| **Waterproofing** | Crystalline Slurry Waterproofing (Penetrating) | `87.97` | `96.91` | `61.16` | 0.05 | 60 yrs | 58 |
...
**Engineering Evaluation Criteria Passed**:
- ✓ Corrosion resistance (92.0/100) meets the minimum 90/100 threshold for extreme coastal saline exposure at Galle
...
**Engineering Evaluation Criteria Passed**:
- ✓ Corrosion resistance (100.0/100) meets the minimum 90/100 threshold for extreme coastal saline exposure at Galle
...
**Engineering Evaluation Criteria Passed**:
- ✓ Adequate corrosion resistance (85.0/100) for moderate coastal salinity conditions at Galle
...
**Engineering Evaluation Criteria Passed**:
- ✓ Corrosion resistance (90.0/100) meets the minimum 90/100 threshold for extreme coastal saline exposure at Galle
...
**Engineering Evaluation Criteria Passed**:
- ✓ Corrosion resistance (95.0/100) meets the minimum 90/100 threshold for extreme coastal saline exposure at Galle
- ✓ Service life of 60 years meets the 50-year design life target
